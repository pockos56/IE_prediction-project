...
#importance_neg, accuracy_tr_neg, accuracy_te_neg, y_hat_train_neg, y_hat_test_neg, res_train_neg, res_test_neg = Stratified_CNL_model_wFiltering_wConsensus_TestOnlyFiltered(-1, min_CNLs=1, consensus_threshold=0.2, allowplots=true, random_seed = 3) # ESI-
importance_pos, accuracy_tr_pos, accuracy_te_pos, y_hat_train_pos, y_hat_test_pos, res_train_pos, res_test_pos = Stratified_CNL_model_wFiltering_wConsensus_TestOnlyFiltered(+1, min_CNLs=1, consensus_threshold=0.2, allowplots=true, allowsave=true,random_seed = 3) # ESI+
